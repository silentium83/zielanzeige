...
const LCDChar font_var_width[256] PROGMEM = {
	...
	{ 3, { 0x08, 0x08, 0x08 } },             // 2D -
	{ 2, { 0x03, 0x03 } },                   // 2E .
	{ 5, { 0x02, 0x04, 0x08, 0x10, 0x20 } }, // 2F /
	{ 5, { 0x3E, 0x45, 0x49, 0x51, 0x3E } }, // 30 0
	{ 3, { 0x21, 0x7F, 0x01 } },             // 31 1
	{ 5, { 0x21, 0x43, 0x45, 0x49, 0x31 } }, // 32 2
	{ 5, { 0x42, 0x41, 0x51, 0x69, 0x46 } }, // 33 3
	{ 5, { 0x0C, 0x14, 0x24, 0x7F, 0x04 } }, // 34 4
	{ 5, { 0x72, 0x51, 0x51, 0x51, 0x4E } }, // 35 5
	{ 5, { 0x1E, 0x29, 0x49, 0x49, 0x06 } }, // 36 6
	{ 5, { 0x43, 0x44, 0x48, 0x50, 0x60 } }, // 37 7
	{ 5, { 0x36, 0x49, 0x49, 0x49, 0x36 } }, // 38 8
	{ 5, { 0x30, 0x49, 0x49, 0x4A, 0x3C } }, // 39 9
	{ 2, { 0x36, 0x36 } },                   // 3A :
	{ 2, { 0x35, 0x36 } },                   // 3B ;
	{ 4, { 0x08, 0x14, 0x22, 0x41 } },       // 3C <
	{ 5, { 0x14, 0x14, 0x14, 0x14, 0x14 } }, // 3D =
	{ 4, { 0x41, 0x22, 0x14, 0x08 } },       // 3E >
	{ 5, { 0x20, 0x40, 0x45, 0x48, 0x30 } }, // 3F ?
	{ 5, { 0x3E, 0x41, 0x4D, 0x51, 0x36 } }, // 40 @
	...
	{ 3, { 0x7F, 0x41, 0x41 } },             // 5B [
	{ 5, { 0x20, 0x10, 0x08, 0x04, 0x02 } }, /* 5C \ */
	{ 3, { 0x41, 0x41, 0x7F } },             // 5D ]
	{ 5, { 0x10, 0x20, 0x40, 0x20, 0x10 } }, // 5E ^
	{ 5, { 0x01, 0x01, 0x01, 0x01, 0x01 } }, // 5F _
	{ 3, { 0x40, 0x20, 0x10 } },             // 60 `
	...
	{ 5, { 0x0E, 0x11, 0x11, 0x0E, 0x15, 0x0C } }, // BD œ
	{ 0, {} }, // BE Ÿ
